...
bi.Product = [
	...
	prefix: 'product',
	images: ['large':[scale:[width:441, height:441, type:ScaleType.APPROXIMATE]],
			 'small':[scale:[width:100, height:100, type:ScaleType.ACCURATE]]],
	constraints:[
		nullable:true,
		maxSize:500000,
		contentType:['image/jpg', 'image/png', 'image/gif', 'image/bmp','image/jpeg']
	]
]
...
bi.SKU = [
	...
	constraints:[
		nullable:true,
		maxSize:500000,
		contentType:['image/bmp', 'image/gif', 'image/png', 'image/jpeg']
	]
]
...
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.mt.is.domain.user.UserRole'
grails.plugin.springsecurity.authority.className = 'com.mt.is.domain.user.Role'
